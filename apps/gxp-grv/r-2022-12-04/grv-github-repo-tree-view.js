...
GRV.init = function () {
	...
	const htm = `
<h1><a href="">gxp-grv</a></h1>
<details id=GRVdet>

	<summary id=GRVsumRepo class="summary-primary" title="View selected items">
		<span id=GRVsumTitle >${ COR.repo }</span>
	</summary>
	...
	if ( !window.GRVdivDetails ) {
		...
		GRVdivDetails = navGRVContent.appendChild( document.createElement( 'div' ) );
